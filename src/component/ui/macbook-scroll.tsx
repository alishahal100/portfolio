...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="lg:min-h-[150vh] bg-black  flex flex-col items-center md:-mt-0 -mt-20  justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
